...
# --- STYLE CSS (CANVA PRO : ÉLÉGANT, JOYEUX & RASSURANT) ---
st.markdown("""
    <style>
...
# --- 1. SECTION HERO (TITRE + IMAGE SCAN) ---
...
with col_text:
    ...
    st.write("""
        Offrez à vos clients une expérience fluide, élégante et sécurisée. 
        Idéal pour les Fast-foods, Dibiteries, Salons de coiffure et Parfumeries.
    """)
    st.markdown("<br>", unsafe_allow_html=True)
    st.info("💡 **Plus de 10 commerces nous font déjà confiance pour leur menu digital.**")
...
# --- 2. ARGUMENTS FORTS (AVEC HYGIÈNE) ---
st.markdown("<h2 style='text-align: center;'>Pourquoi choisir le Digital ?</h2>", unsafe_allow_html=True)
st.write("<br>", unsafe_allow_html=True)

a1, a2, a3 = st.columns(3)
with a1:
    st.markdown("""<div class="pro-card"><div class="icon-box">🧼</div><h3>Hygiène Maximale</h3><p>Solution "Zero-Contact". Plus de menus sales ou déchirés qui passent de main en main.</p></div>""", unsafe_allow_html=True)
with a2:
    st.markdown("""<div class="pro-card"><div class="icon-box">🚀</div><h3>Rapidité & Gain de temps</h3><p>Vos clients consultent les prix instantanément. Moins de stress pour vos serveurs.</p></div>""", unsafe_allow_html=True)
with a3:
    st.markdown("""<div class="pro-card"><div class="icon-box">💎</div><h3>Image Pro</h3><p>Donnez une image moderne et innovante à votre commerce. Différenciez-vous de la concurrence.</p></div>""", unsafe_allow_html=True)

st.write("<br>", unsafe_allow_html=True)
st.divider()

# --- 3. LES TARIFS (PACKS CFA) ---
st.markdown("<h2 style='text-align: center;'>Nos Offres Adaptées 💳</h2>", unsafe_allow_html=True)
st.write("<br>", unsafe_allow_html=True)
...
with p1:
    ...
    <div class="pro-card">
        ...
        <p style="font-size: 0.8rem; opacity: 0.8;">Salons de coiffure, Boutiques</p>
...
with p2:
    ...
    <div class="pro-card" style="border: 2px solid #38bdf8; background: rgba(56, 189, 248, 0.1);">
        ...
        <p style="font-size: 0.8rem; opacity: 0.8;">Dibiteries, Fast-food, Restaurants</p>
        <hr style="opacity: 0.2;">
        <ul>
            <li>✅ Menu Illimité + Catégories</li>
            <li>✅ <b>Bouton de Commande WhatsApp</b></li>
            <li>✅ 3 Stickers QR Codes offerts</li>
            <li>✅ Formation Express</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
...
with p3:
    ...
    <div class="pro-card">
        ...
        <p style="font-size: 0.8rem; opacity: 0.8;">Hôtels, Chaînes de restaurants</p>
        <hr style="opacity: 0.2;">
        <ul>
            <li>✅ Gestion Multi-sites</li>
            <li>✅ Design 100% sur-mesure</li>
            <li>✅ Statistiques de visite</li>
            <li>✅ Support Prioritaire 24h/7j</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
...
# --- 4. SECTION CONTACT ---
st.markdown("<h2 style='text-align: center;'>Prêt à passer au digital ? 🚀</h2>", unsafe_allow_html=True)
...
with contact_l:
    ...
    <div class="contact-box">
        <h3 style="color: #764ba2 !important; margin-top:0;">M'envoyer une demande</h3>
        <form action="https://formsubmit.co/alymomardiallo75@gmail.com" method="POST">
            ...
            <textarea name="message" rows="4" placeholder="Quel service vous intéresse ?"></textarea>
            <button type="submit" style="width:100%; background: #764ba2; color: white; border: none; padding: 15px; border-radius: 12px; font-weight: bold; cursor: pointer;">ENVOYER MAINTENANT</button>
        </form>
    </div>
    """, unsafe_allow_html=True)
...
with contact_r:
    ...
    st.markdown(f"""
        <div style="text-align: center; padding: 40px; background: rgba(255,255,255,0.1); border-radius: 30px; height: 100%; display: flex; flex-direction: column; justify-content: center; align-items: center;">
            <p style="font-size: 1.4rem; font-weight:600;">Besoin d'une réponse immédiate ?</p>
            <p>Cliquez ci-dessous pour discuter directement avec moi sur WhatsApp.</p>
            <br>
            <a href="{whatsapp_url}" class="whatsapp-link" target="_blank">
                💬 CONTACTER ALY SUR WHATSAPP
            </a>
            <p style="margin-top: 30px; font-size: 0.9rem; opacity: 0.8;">Réponse sous 24h garantie.</p>
        </div>
    """, unsafe_allow_html=True)
